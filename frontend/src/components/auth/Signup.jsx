...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex bg-gray-50">
      ...
      <div className="flex-1 bg-gradient-to-br from-sky-400 via-blue-500 to-indigo-600 flex items-center justify-center p-8 lg:p-12">
        <div className="max-w-md text-white">
          ...
          <p className="text-blue-100 mb-8 leading-relaxed">
            ...
            and take the next step in your professional growth.
          </p>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4 bg-white/10 backdrop-blur-sm p-4 rounded-xl border border-white/20">
              <div className="bg-white/20 p-2 rounded-lg">
                <IoBriefcaseOutline className="text-lg text-white" />
              </div>
              <div>
                <h3 className="font-semibold text-sm">Discover Opportunities</h3>
                <p className="text-blue-100 text-xs">Access thousands of job listings from leading companies</p>
              </div>
            </div>
            <div className="flex items-center gap-4 bg-white/10 backdrop-blur-sm p-4 rounded-xl border border-white/20">
              <div className="bg-white/20 p-2 rounded-lg">
                <IoPeopleOutline className="text-lg text-white" />
              </div>
              <div>
                <h3 className="font-semibold text-sm">Build Your Profile</h3>
                <p className="text-blue-100 text-xs">Showcase your skills and experience to recruiters</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-8">
        <div className="w-full max-w-sm">
          ...
          <div className="flex bg-gray-100 rounded-lg p-1 mb-6">
            <Link 
              to="/login" 
              className="flex-1 py-2 px-4 text-sm font-medium rounded-md text-gray-500 hover:text-gray-700 text-center"
            >
              Login
            </Link>
            <button className="flex-1 py-2 px-4 text-sm font-medium rounded-md bg-white text-blue-600 shadow-sm">
              Sign Up
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                <IoPersonOutline className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 text-lg" />
                <input
                  type="text"
                  name="name"
